...
app.get('/', (req, res) => { const html = fs.readFileSync(path.join(__dirname, 'public', 'backtest.html'), 'utf8'); res.send(html); });
...
app.listen(3001, () => console.log('Backtester Dashboard running on http://localhost:3001'));
